...
```{r prevalence-data, fig.cap = "Distribution of model-estimated prevalences (95% CI's reported by modelling studies) collected by @levin_assessing_2020. Additional points show 95% CIs recreated by assuming logit-normal distribution of prevalence.", fig.height = 9.5, fig.width = 6}
